import { IMPORTED_NORMAL_SECRET_BANK, IMPORTED_SUPERNATURAL_SECRET_BANK, IMPORTED_TRAIT_BANK, } from "./databanks_imported.ts";
const STREET_ROOTS = [
    "Church",
    "French",
    "Miskatonic",
...
function uniquePush(target, item, seen) {
...
function buildTraitBank(targetSize = 12000) {
    const out = [];
    const seen = new Set();
...
function buildNormalSecretBank(targetSize = 15000) {
    const out = [];
    const seen = new Set();
...
function buildSupernaturalSecretBank(targetSize = 5000) {
    const out = [];
    const seen = new Set();
...
function buildFacilityBank(cores, operators, modifiers, targetSize) {
    const out = [];
    const seen = new Set();
...
export const INDUSTRIAL_FACILITY_BANK = buildFacilityBank(INDUSTRIAL_FACILITY_CORES, INDUSTRIAL_OPERATORS, INDUSTRIAL_FACILITY_MODIFIERS, 3600);
export const SOCIAL_FACILITY_BANK = buildFacilityBank(SOCIAL_FACILITY_CORES, SOCIAL_OPERATORS, SOCIAL_FACILITY_MODIFIERS, 3600);
export const INTERNAL_CACHE_DATABANK = {
    traits: TRAIT_BANK,
